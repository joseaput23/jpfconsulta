...
CREATE TABLE `series` (
  ...
  CONSTRAINT `series_ibfk_1` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`)
...
CREATE TABLE `series_generos` (
  ...
  CONSTRAINT `series_generos_ibfk_1` FOREIGN KEY (`serie_id`) REFERENCES `series` (`id`),
  CONSTRAINT `series_generos_ibfk_2` FOREIGN KEY (`genero_id`) REFERENCES `generos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `series_reparto` (
  ...
  PRIMARY KEY (`serie_id`,`reparto_id`),
  KEY `reparto_id` (`reparto_id`),
  CONSTRAINT `series_reparto_ibfk_1` FOREIGN KEY (`serie_id`) REFERENCES `series` (`id`),
  CONSTRAINT `series_reparto_ibfk_2` FOREIGN KEY (`reparto_id`) REFERENCES `reparto` (`reparto_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-10-10 19:33:37
